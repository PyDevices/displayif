...
| `jpegio/` | Test corpus + Pillow fidelity reference for the `jpegio` module (`make_corpus.py`, `reference.py`, `jpegwalk.py`; frames and `reference.json` under `frames/`, see its README). The unix-MicroPython tests arrive with the module. |
