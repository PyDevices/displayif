...
| [qstrs-and-usermod-defines.md](qstrs-and-usermod-defines.md) | Why an `MP_QSTR_` name must never sit behind a define this usermod supplies, and the check that enforces it |
