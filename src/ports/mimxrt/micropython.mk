...
CFLAGS_USERMOD += -I$(DISPLAYIF_MOD_DIR)/src/ports/mimxrt
...
SRC_USERMOD_C += \
    $(DISPLAYIF_MOD_DIR)/src/ports/mimxrt/mod_dotclockframebuffer_elcdif.c \
    $(DISPLAYIF_MOD_DIR)/src/ports/mimxrt/mimxrt1060_lcd_pins.c
...
SRC_USERMOD_C := $(filter-out $(DISPLAYIF_MOD_DIR)/src/ports/common/notimpl/mod_mipidsi.c,$(SRC_USERMOD_C))
SRC_USERMOD_C += \
    $(DISPLAYIF_MOD_DIR)/src/ports/mimxrt/mod_mipidsi.c \
    $(DISPLAYIF_MOD_DIR)/src/ports/mimxrt/mimxrt1176_dsi_display.c
CFLAGS_USERMOD += \
...
ifeq ($(MCU_SERIES),MIMXRT1062)
SRC_USERMOD_C := $(filter-out $(DISPLAYIF_MOD_DIR)/src/ports/common/notimpl/mod_i80bus.c,$(SRC_USERMOD_C))
SRC_USERMOD_C += \
    $(DISPLAYIF_MOD_DIR)/src/ports/mimxrt/mod_i80bus.c \
...
ifeq ($(MCU_SERIES),MIMXRT1062)
SRC_USERMOD_C += $(DISPLAYIF_MOD_DIR)/src/ports/mimxrt/rgbmatrix_pm.c
endif
