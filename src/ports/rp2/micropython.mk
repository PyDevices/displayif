...
CFLAGS_USERMOD += -I$(DISPLAYIF_MOD_DIR)/src/ports/rp2
CFLAGS_USERMOD += -I$(DISPLAYIF_MOD_DIR)/src/ports/rp2/picodvi/libdvi

PICODVI_LIBDVI_SRC = \
    $(DISPLAYIF_MOD_DIR)/src/ports/rp2/picodvi/libdvi/dvi.c \
    $(DISPLAYIF_MOD_DIR)/src/ports/rp2/picodvi/libdvi/dvi_serialiser.c \
    $(DISPLAYIF_MOD_DIR)/src/ports/rp2/picodvi/libdvi/dvi_timing.c \
    $(DISPLAYIF_MOD_DIR)/src/ports/rp2/picodvi/libdvi/tmds_encode.c \
    $(DISPLAYIF_MOD_DIR)/src/ports/rp2/picodvi/libdvi/tmds_encode.S
...
SRC_USERMOD_C += $(DISPLAYIF_MOD_DIR)/src/ports/rp2/picodvi_rp2350.c
else
SRC_USERMOD_C += \
