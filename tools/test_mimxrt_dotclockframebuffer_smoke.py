"""Smoke test for dotclockframebuffer.DotClockFramebuffer (mimxrt eLCDIF).
...
print("dotclockframebuffer.DotClockFramebuffer mimxrt smoke test")

import dotclockframebuffer

if sys.platform != "mimxrt":
    try:
        dotclockframebuffer.DotClockFramebuffer(
            de=0,
            vsync=0,
            hsync=0,
            dclk=0,
        ...
        print("dotclockframebuffer.DotClockFramebuffer not available on this SoC (expected off mimxrt)")
        raise SystemExit(0)
...
try:
    ...
    print("dotclockframebuffer.DotClockFramebuffer not available on this mimxrt SoC:", exc)
    raise SystemExit(0)
