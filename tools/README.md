# displayif tools (smoke tests)

Hardware / developer smoke scripts. Unit tests live in [`tests/`](../tests/).
...
./micropython/ports/rp2/build-RPI_PICO/micropython displayif/tools/test_picodvi_smoke.py
./micropython/ports/mimxrt/build-TEENSY41/micropython displayif/tools/test_rgbmatrix_smoke.py
./micropython/ports/mimxrt/build-TEENSY41/micropython displayif/tools/test_mimxrt_dotclockframebuffer_smoke.py
./micropython/ports/mimxrt/build-MIMXRT1170_EVK/micropython displayif/tools/test_mimxrt_mipidsi_smoke.py
